...
{   
    ...
    $html = '<table class="table">
        <tbody>
          <tr>
            <td rowspan="6" class="text-left" style="width: 60%">
            '.get_po_logo(250, "img img-responsive").'
             <br>'.format_organization_info().'
             <br><strong>'._l('pur_ship_to').'</strong>   
             <br>'. $ship_to.'
             <br>'. _l('order_date').': '. $day.'
            </td>
      ...
      $html .= ' </tbody></table><hr style="height:2px;border-width:0;color:gray;background-color:gray">';
    ...
    //  $html .= '<div class="col-md-12 mtop15">
     ...
     $html .= '<table class="">
        <tbody>
          <tr>
            <td rowspan="2" class="text-left" style="width: 60%">
          ...
          <tr>
            <td class="text-left" style="width: 30%">
                ...
                <br>
                <br>
                <br><b>Our Excise details are as under:</b>
                <br>GSTIN. No. : 27AAGFK1684C1ZG
                <br>PAN NO. : AAGFK1684C
            </td>
            <td></td>
          </tr>
