...
//$info_right_column .= '<br /><b style="color: indianred">' . _l('invoice_data_date') . '</b> ' . _d($invoice->date) . '<br />';
...
$info_left_column .=  '<br /><b style="color: #424242">' . format_organization_info() . '<br />';
$info_left_column .=  '<br />';
$info_left_column .= ' </tbody></table><hr style="height:1px;border-width:0;color:gray;background-color:gray"><br />';
$info_left_column .=  '<br />';
...
$info_left_column .= '<br /><b style="color: indianred">' . _l('invoice_No') . '</b> ' .$invoice_number . '<b style="color: indianred">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . _l('po_no') . '</b> ' .$value . '<br />';
$info_left_column .=  '<b style="color: indianred">' . _l('invoice_data_date') . '</b> ' . _d($invoice->date) . '<br />';
$info_left_column .=  '<br />';

$info_left_column .= ' </tbody></table><hr style="height:1px;border-width:0;color:gray;background-color:gray">';
...
$organization_info = '<b style="color:indianred;">' . _l('invoice_bill_to') . ':</b><br>';
...
// The Table
$pdf->Ln(hooks()->apply_filters('pdf_info_and_table_separator', 7));
