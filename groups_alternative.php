            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <!-- Simple table without DataTables for testing -->
                        ...
                        <p><small><strong>Note:</strong> This is a simplified version without DataTables to test basic functionality.</small></p>
                    </div>
                </div>
            </div>
        </div>
